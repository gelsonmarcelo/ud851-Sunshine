...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView errorLoadingDataView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorLoadingDataView = (TextView) findViewById(R.id.loading_fail);
